...
var bullet_scene = preload("res://player_L/game 4/player1_4/game_mo2.tscn")
var d: int = 0
var s: int = 300
var palyer_W: int = 16
var shoot_time := 0.5
...
func _process(delta: float):
	shoot += delta
	if Input.is_action_pressed("fire_2") and shoot > shoot_time:
		shoot = 0
	...
	if Input.is_action_pressed("left_2"):
		d = -1
	elif Input.is_action_pressed("right_2"):
		d = 1
	else:
		d = 0
